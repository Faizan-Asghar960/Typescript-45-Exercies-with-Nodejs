...
while (guestList.length > 2) {
    ...
    console.log("Soory, ".concat(removeGuest, ",I cant inivte you to dinner"));
}
// sending a initaion to the last two guest on the list
console.log("innitaions to the Last 2 Guests");
guestList.forEach(function (lasttwo) { return console.log("luckally ".concat(lasttwo, ", you are still invited to Dinner")); });
