...
var current_users = ["Farhan", "ali", "ahsan", "imran", "qurban"];
// Array of new usersd
var new_users = ["Hamza", "ali", "arish", "imran", "khan"];
...
new_users.forEach(function (new_one_user) {
    ...
    var over_coundition = current_users.some(function (current_one_user) { return current_one_user.toLowerCase() === new_one_user.toLowerCase(); });
