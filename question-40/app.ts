// wuestion, No, 40: Album: Write a function called make_album() that builds a Object describing a music album. 
...
// Calling three function and creating 3 veribles with different values

let album1 = make_album("Mr.Fazee", "album title 1");
 
let album2 = make_album("Tabish", "album title 2");

// Calling a make album function with 3rd perameter
let album3 = make_album("Abrar", "album title 3", 10);

// printing  the veribale
